...
CONFIG_CLEAN_FILES = Doxyfile pidgin.apspec \
	pidgin/data/pidgin.desktop.in pidgin/data/pidgin.pc \
	pidgin/data/pidgin-uninstalled.pc pidgin/data/pidgin-2.pc \
	pidgin/data/pidgin-2-uninstalled.pc \
	pidgin/plugins/perl/common/Makefile.PL \
	libpurple/data/purple.pc libpurple/data/purple-uninstalled.pc \
...
am__DIST_COMMON = $(srcdir)/Doxyfile.in $(srcdir)/Makefile.in \
	$(srcdir)/config.h.in $(srcdir)/pidgin.apspec.in \
	$(srcdir)/pidgin.spec.in \
	$(top_srcdir)/libpurple/data/purple-2-uninstalled.pc.in \
	$(top_srcdir)/libpurple/data/purple-2.pc.in \
	$(top_srcdir)/libpurple/data/purple-uninstalled.pc.in \
	$(top_srcdir)/libpurple/data/purple.pc.in \
	$(top_srcdir)/libpurple/plugins/perl/common/Makefile.PL.in \
	$(top_srcdir)/pidgin/data/pidgin-2-uninstalled.pc.in \
	$(top_srcdir)/pidgin/data/pidgin-2.pc.in \
	$(top_srcdir)/pidgin/data/pidgin-uninstalled.pc.in \
	$(top_srcdir)/pidgin/data/pidgin.desktop.in.in \
	$(top_srcdir)/pidgin/data/pidgin.pc.in \
...
ACLOCAL = ${SHELL} /home/foss/Desktop/pidgin-2.13.0/missing aclocal-1.15
ALLOCA = 
...
AR = ar
AUTOCONF = ${SHELL} /home/foss/Desktop/pidgin-2.13.0/missing autoconf
AUTOHEADER = ${SHELL} /home/foss/Desktop/pidgin-2.13.0/missing autoheader
AUTOMAKE = ${SHELL} /home/foss/Desktop/pidgin-2.13.0/missing automake-1.15
...
DUMPBIN = 
DYNALOADER_A = 
DYNAMIC_PRPLS = bonjour gg irc jabber novell oscar sametime  simple zephyr
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EGREP = /bin/grep -E
...
EXEEXT = 
FARSTREAM_CFLAGS = -pthread -I/usr/include/farstream-0.2 -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
...
GNUTLS_LIBS =  -lgnutls
GREP = /bin/grep
GSTAPP_CFLAGS = -pthread -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
...
GSTREAMER_VER = 1.0
GSTVIDEO_CFLAGS = -pthread -I/usr/include/gstreamer-1.0 -I/usr/include/orc-0.4 -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
GSTVIDEO_LIBS = -lgstvideo-1.0 -lgstbase-1.0 -lgstreamer-1.0 -lgobject-2.0 -lglib-2.0
GTKSPELL_CFLAGS = -pthread -I/usr/include/gtkspell-2.0 -I/usr/include/gtk-2.0 -I/usr/lib/x86_64-linux-gnu/gtk-2.0/include -I/usr/include/gio-unix-2.0/ -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pixman-1 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng16 -I/usr/include/pango-1.0 -I/usr/include/harfbuzz -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/libpng16
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/foss/Desktop/pidgin-2.13.0/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_NAME = pidgin
PACKAGE_STRING = pidgin 2.13.0
PACKAGE_TARNAME = pidgin
PACKAGE_URL = 
PACKAGE_VERSION = 2.13.0
PANGO_CFLAGS = -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
...
PERL_LIBS = -Wl,-E -fstack-protector-strong -L/usr/local/lib -L/usr/lib/x86_64-linux-gnu/perl/5.26/CORE -lperl -ldl -lm -lpthread -lcrypt
...
PO_IN_DATADIR_FALSE = 
PO_IN_DATADIR_TRUE = 
PURPLE_LT_VERSION_INFO = 13:0:13
PURPLE_MAJOR_VERSION = 2
PURPLE_MICRO_VERSION = 0
PURPLE_MINOR_VERSION = 13
...
ZEPHYR_LDFLAGS = 
ZEPHYR_LIBS = 
abs_builddir = /home/foss/Desktop/pidgin-2.13.0
abs_srcdir = /home/foss/Desktop/pidgin-2.13.0
abs_top_builddir = /home/foss/Desktop/pidgin-2.13.0
abs_top_srcdir = /home/foss/Desktop/pidgin-2.13.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/foss/Desktop/pidgin-2.13.0/install-sh
...
pidgin.apspec: $(top_builddir)/config.status $(srcdir)/pidgin.apspec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin/data/pidgin.desktop.in: $(top_builddir)/config.status $(top_srcdir)/pidgin/data/pidgin.desktop.in.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin/data/pidgin.pc: $(top_builddir)/config.status $(top_srcdir)/pidgin/data/pidgin.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin/data/pidgin-uninstalled.pc: $(top_builddir)/config.status $(top_srcdir)/pidgin/data/pidgin-uninstalled.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin/data/pidgin-2.pc: $(top_builddir)/config.status $(top_srcdir)/pidgin/data/pidgin-2.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin/data/pidgin-2-uninstalled.pc: $(top_builddir)/config.status $(top_srcdir)/pidgin/data/pidgin-2-uninstalled.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin/plugins/perl/common/Makefile.PL: $(top_builddir)/config.status $(top_srcdir)/pidgin/plugins/perl/common/Makefile.PL.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libpurple/data/purple.pc: $(top_builddir)/config.status $(top_srcdir)/libpurple/data/purple.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libpurple/data/purple-uninstalled.pc: $(top_builddir)/config.status $(top_srcdir)/libpurple/data/purple-uninstalled.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libpurple/data/purple-2.pc: $(top_builddir)/config.status $(top_srcdir)/libpurple/data/purple-2.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libpurple/data/purple-2-uninstalled.pc: $(top_builddir)/config.status $(top_srcdir)/libpurple/data/purple-2-uninstalled.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
